...
class GenerationPipeline:
    ...
    async def generate_gs(self, request: GenerateRequest) -> GenerateResponse:
        ...
        trellis_result = self.trellis.generate(
            TrellisRequest(
                images=[original_image_without_background, image_without_background_2, image_without_background_3],
                seed=request.seed,
        ...
        if self.settings.send_generated_files:
            image_edited_base64 = to_png_base64(original_image_without_background)
            image_without_background_base64 = to_png_base64(original_image_without_background)
